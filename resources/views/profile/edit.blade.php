<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
      <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
        <div class="max-w-xl">
            <form action="{{ route('users.update_avatar', $user) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                @csrf
                @method('PATCH')

                <div>
                    <label for="avatar" class="block text-sm font-medium text-gray-700">Загрузите/обновите аватар</label>
                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                        <div class="space-y-1 text-center">
                            ...
                            <p class=" text-xs text-gray-500">{{ $user->avatar_name }}</p>
                        </div>
                    </div>
                </div>
