...
<head>
    ...
    <title>{{ config('app.name', 'Личный кабинет студента') }}</title>
...
<aside id="default-sidebar"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            <li>
                <a class="flex items-center p-2 text-gray-900 rounded-lg  dark:hover:bg-gray-700 group">
                    ...
                    <span class="ml-3">Личный кабинет @if (Auth::user()->role == 'teacher')
                            {{ __('преподавателя') }}
...
<div class="p-2 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        <p class=" text-2xl font-medium text-center mt-3 mb-3">Личный кабинет</p> 
        @yield('content')
    </div>
</div>
</body>
